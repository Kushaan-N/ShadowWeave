...
% RoboWM (NeurIPS 2026) review is double-blind on OpenReview (camera-ready is
% de-anonymized per the CFP). For the SUBMISSION, comment the named block and
% uncomment the anonymous one.
\author{Kushaan Naskar\\
University of Massachusetts Amherst\\
\texttt{kushaannaskar@gmail.com}}
% \author{Anonymous\\ NeurIPS 2026 RoboWM Workshop Submission}
