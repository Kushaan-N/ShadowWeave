...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.87\linewidth]{shadow_gain_ci.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.94\linewidth]{decomp_curves.png}
...
infers dense voxel geometry, and even hallucinates geometry beyond the visible frontier, from a
...
power lies. We hope the protocol is reused, since many occupancy-completion results would read
