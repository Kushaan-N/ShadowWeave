...
5--10\,s horizons (at 1\,s the two are comparable).
...
amodal \emph{completion}, not multi-step \emph{forecasting}: the pure-dynamics residual is small (a
statistically significant but $\le$+0.007 gain at 5\,s), and we frame the contribution accordingly.
