...
every horizon), and its uncertainty is **better calibrated inside shadow (ECE 0.043–0.047) than
in directly observed space (0.058–0.086)**. We introduce a decomposition that separates *amodal
